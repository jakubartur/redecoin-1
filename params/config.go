...
//		banner += "Consensus: unknown\n"
	...
	banner += "\n"
        banner += fmt.Sprintf("Node List: \n")
        banner += fmt.Sprintf("Warszawa WAW \n")
        banner += fmt.Sprintf("Frankfurt DE \n")
        banner += fmt.Sprintf("Gravelines GRA \n")
        banner += fmt.Sprintf("Strasburg SBG \n")
        banner += fmt.Sprintf("Beauharnois BHS \n")
        banner += fmt.Sprintf("Londyn UK \n")
        banner += fmt.Sprintf("Sydney SYD \n")
        banner += fmt.Sprintf("Singapur SGP \n")
